...
{
    public unsafe static class Hash32
    {
        ...
        public static int GetHashCode(byte[] bytes, int offset, int length)
        {
            uint crc = 0xFFFFFFFF;
            ...
            {
                return GetHashCode(pinned, offset, length);
            }
        }
