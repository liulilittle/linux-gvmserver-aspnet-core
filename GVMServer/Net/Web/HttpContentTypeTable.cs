namespace GVMServer.Net.Web
{
    ...
    public static class HttpContentTypeTable
    {
        ...
        {
            return g_ContentTypeTables;
        }

        public static bool Add(string extension, string contentType)
        {
            ...
            {
                if (g_ContentTypeTables.ContainsKey(extension))
                {
                    return false;
                }
                g_ContentTypeTables.Add(extension, contentType);
                return true;
            }
        }
